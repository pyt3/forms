...
if (
        ...
        if (tag_a.length > 0) {
            ...
            new Promise((resolve, reject) => {
                ...
                let t2 = {
                    ...
                    e_name: (e = document.getElementsByName("catagory")[0]).options[
                        e.selectedIndex
                    ].innerText,
                    ...
                    e_dept: (e = document.getElementsByName("sub_dept")[0]).options[
                        e.selectedIndex
                    ].innerText,
                    e_date: document.getElementsByName("receive_date")[0].value,
                    warranty_end: document.getElementsByName(
                        "w_finish_date_repair_part",
                    )[0].value,
                ...
                if (t.e_price == "" || t.e_price == 0) t.e_repair_percent = "-";
                    ...
                    t.e_repair_percent = ((t.e_repair_price / t.e_price) * 100).toFixed(
                        2,
                    );
                }
    ...
    page
        .toLowerCase()
        .indexOf("//nsmart.nhealth-asia.com/mtdpdb01/jobs/bjoba.php") > -1
) {
